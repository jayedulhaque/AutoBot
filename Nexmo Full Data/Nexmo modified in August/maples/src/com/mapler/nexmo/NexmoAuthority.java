...
public class NexmoAuthority extends javax.swing.JPanel implements INotifier {
    ...
    private void initComponents() {
        ...
        if (TblModel.getColumnModel().getColumnCount() > 0) {
            TblModel.getColumnModel().getColumn(0).setHeaderValue("Serial");
            TblModel.getColumnModel().getColumn(1).setHeaderValue("Api Key");
            TblModel.getColumnModel().getColumn(2).setHeaderValue("Api Secret");
            TblModel.getColumnModel().getColumn(3).setHeaderValue("Numbers");
            TblModel.getColumnModel().getColumn(4).setHeaderValue("Action");
        }
